...
import { CustomerResetpasswordAction, customerDetailsAction, deleteUserAction, updateaccountstatusAction, updateuserdetailsAction } from '../Redux/Action/UserAction';
...
formik.setFieldValue('second_line_address', userdetails.second_line_address)
...
const updateaccountstatus=(status)=>{
    dispatch(updateaccountstatusAction({
...
const resetPasword=()=>{
  ...
  dispatch(CustomerResetpasswordAction({
    ...
    var userprofile =useCallback( () => {
    
   
        const encodedEncrypted = Encryptedid(userdetails?.salonId);
       
        navigate("/Salon-customers/"+encodedEncrypted);
      },[]);
           ...
           <div className="main-content">
                 ...
                 <div className="container-fluid">
                   ...
                   <div className='col-lg-12 d-flex justify-content-end'>
                         ...
                         <NavLink to={"/Salon-Customer-Completed-Consultation-Forms/"+Encryptedid(userdetails?._id)}>  <button className="btn cre_new_one">Consultations</button></NavLink>
                     </div>  
             ...
             <div className='container-fluid'>
               ...
               <form onSubmit={formik.handleSubmit}>
                         <div className="col-xl-12">
                          ...
                          <button type='submit' className='new_update'>Update</button>
                                         </div>
                                       ...
                                       <div className='contact_details custom'>
                                               ...
                                               {formik.touched.first_name && formik.errors.first_name && (
                                                          <div className='error show_error'>{formik.errors.first_name}</div>
                                                        )}
                                                <div className='form_fields_main mb-2'>
                                                   <label>Surname</label>
                                               ...
                                               {formik.touched.last_name && formik.errors.last_name && (
                                                        <div className='error show_error'>{formik.errors.last_name}</div>
                                                      )}
                                                <div className='form_fields_main mb-2'>
                                                   <label>Email</label>
                                               ...
                                               {formik.touched.email && formik.errors.email && (
                                                        <div className='error show_error'>{formik.errors.email}</div>
                                                      )}
                                                <div className='form_fields_main mb-2'>
                                                   <label>Phone</label>
                                                  ...
                                                  />
                                                    ...
                                                    <div className='error show_error'>{formik.errors.phone_number}</div>
                                                  )}
                                       ...
                                       <div className='contact_details'>
                                           <div className='row'>
                                               ...
                                               <div className='form_fields_main additional'>
                                                   <label> Address</label>
                                                   <input type="text" class="form-control" id="" placeholder=""   name="first_line_address" 
                                                      value={formik.values.first_line_address}   onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}/>
                                                   <input type="text" class="form-control" id="" placeholder=""   name="second_line_address" 
                                                      value={formik.values.second_line_address}   onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}  />
                                                   <input type="text" class="form-control" id="" placeholder="" name="city" 
                                                      value={formik.values.city}   onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur} />
                                                   <input type="text" class="form-control" id="" placeholder=""  name="pin_code" 
                                                      value={formik.values.pin_code}   onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}   />
                                               ...
                                               <div className='col-lg-7'>
                                                   ...
                                                   <ul>
                                                       <li>Last Log In
                                                       <p>{moment(userdetails.lastLogin).format("DD/MM/YYYY")}</p>
                                                       </li>
                                                       <li>Account Status
                                                       <p> <img src={require('../assets/images/check_circle.png')} /> {userdetails?.status==1?"Active":"Inactive"}</p>
                                                       </li>
                                                       <li>Live / Suspend
                                                       <select class="selected_status" aria-label=".form-select-lg example" onChange={(e)=>{
                                                        updateaccountstatus(e.target.value)
                                                       }}>
                                                       <option  value="1" selected={userdetails?.status_account==1}><img src={require('../assets/images/check_circle.png')} /> Live</option>
                                                       <option value="0" selected={userdetails?.status_account==0} >Suspend</option>

                                                     </select>
                                                       </li>
                                                       <li>Password Reset
                                                       <button className='reset_btn' onClick={resetPasword}>Reset Password</button>
                                                       </li>
                                                       <li>Delete Salon 
                                          ...
                                          <div class="table-responsive">
                                             <table id="" class="table dt-responsive dealers_table nowrap w-100">
                                               ...
                                               <tr>
                                                   ...
                                                   <td>25/07/2023</td>
                                                   <td><button className='view_patch'>View in PatchPort</button></td>
                                               </tr>
                                               <tr>
                                                   <td>12323</td>
                                                   <td>Botox - Frown Lines</td>
