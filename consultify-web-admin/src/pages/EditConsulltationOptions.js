...
export default function EditConsultationOptions({
  formDatavalue,
  setFormData,
  nextStep,
  prevStep,
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (values.submittype == 0) {
        ...
        dispatch(submitconsultationform(formDatavalue)).then(function () {
                  ...
                  <div className="create_tab fixed_btn ms-0">
                    ...
                    <div className="row align-items-center">
                      <div className="new-bott-btn">
                        ...
                        <span>
                          <div className="edit-consultation-btn">
