                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                   <div>
                                          ...
                                          <div className='d-flex justify-content-center align-items-center'>
                                               <h4 class="mb-sm-0 font-size-28">All Treatments </h4>
                                          <p className='total'>203</p>
                                          </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div className="col-2">  
                              ...
                              <div className='col-2'>
                                      <span>
                                        <NavLink to="/Create-treatement">  <button  class="btn cre_new">Create New</button></NavLink>
                                        </span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center flex-wrap mb-3 position-relative">
                                                <h4 class="title_text">Treatments</h4>
                                            </div>
