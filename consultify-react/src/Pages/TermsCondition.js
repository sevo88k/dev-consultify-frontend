                ...
                <div class="privacy_text">
                    <div class="header-logo text-center">
                        <a class="terms-and-conditions link" href="#">
                            <img class="terms-and-conditions-logo" src={require("../assets/img/logo.svg").default} alt="logo" />
                        </a>
                    </div>
                    ...
                    <ul class="margain-li-b">
                        ...
                        <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Consultify.</li>
                        ...
                        <li><b>Website</b> refers to Consultify , accessible from www.consultifyapp.com</li>
                    ...
                    <ul>
                        <li>By email: <a href="#">hello@consultifyapp.com</a></li>
                    </ul>
                </div>
