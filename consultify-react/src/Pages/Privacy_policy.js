    ...
    return (
        ...
        <div class="privacy_text">
            <div class="header-logo text-center">
                <a class="privacy-and-policy link" href="#">
                    <img class="privacy-and-policy-logo" src={require("../assets/img/logo.svg").default} alt="logo" />
                </a>
            </div>
            ...
            <ul class="margain-li-b">
                ...
                <li><b>Facebook Fan Page</b> is a public profile named Consultify  specifically created by the
                    Company on the Facebook social network, accessible from www.consultifyapp.com
                </li>
           ...
           <h5>TRACKING TECHNOLOGIES AND COOKIES</h5>
            ...
            <p>We will not store or collect Your payment card details. That information is provided directly to Our third-party payment processors whose use of Your personal information is governed by their Privacy Policy. These payment processors adhere to the standards set by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, Mastercard, American Express and Discover. PCI-DSS requirements help ensure the secure handling of payment information.</p>
             ...
             <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the Facebook Fan Page (www.consultifyapp.com), the Company and the operator of the social network Facebook are Joint Controllers.</p>
