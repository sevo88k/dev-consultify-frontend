          ...
          <div className="row">
            <div className="col-xl-2 col-lg-3 ">
              <div className="overflow_prop">
                <ul className="problem_tabs p-0 mb-0">
                  {data?.map((item, i) => {
                    return (
                      <li
                        onClick={() => {
                ...
                <div className="problem_desc border-radius-prop">
                  ...
                  <div className="prblm_inner_content d-flex flex-column justify-content-between">
                    <div>
                      ...
                      <p>
                        Our symptom checker provides as likely diagnosis based
                        on your symptoms, which you can then learn more about in
                        our education page. A video consultation is recommended
                        to help reach a definitive diagnoses where we offer
