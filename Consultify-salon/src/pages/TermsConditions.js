    ...
    <Container>
       <div className="privacy_text">
            ...
            <ul  className="margain-li-b">
                ...
                <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to The Brow Factory, 104 Victoria Road, Scarborough, YO11 1SL.</li>
            ...
            <p>If You wish to place an Order for Goods available on the Service, You may be asked to supply certain information relevant to Your Order including, without limitation, Your credit card number, the expiration date of Your credit card, Your billing address, and Your shipping information.</p>
            ...
            <p>Your right to cancel an Order only applies to Goods detailed in our Returns Policy that are returned in the same condition as You received them. You should also include all of the products instructions, documents and wrappings. Goods that are damaged or not in the same condition as You received them or which are worn simply beyond opening the original packaging will not be refunded. You should therefore take reasonable care of the purchased Goods while they are in Your possession.</p>

            <p>We will reimburse You no later than 7 days from the day on which We receive Your order back. We will use the same means of payment as You used for the Order, and You will not incur any fees for such reimbursement.</p>
            ...
            <ul>
                ...
                <li>Training courses purchased via the website - date exchangeable but non refundable</li>
            </ul>
