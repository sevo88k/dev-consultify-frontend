...
import { Col, Container, InputGroup, Modal, Navbar, Row } from "react-bootstrap";
import { Form, Link, NavLink, useParams } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { preCareListAction } from "../Redux/Action/CustomerAuthAction";
...
const PrePostCare = () => {
  ...
  return (
    ...
    <div className="consulting_form">
      ...
      <Navbar
        expand="lg"
        className={ "bg-body-tertiary header-blck"
        }
      >
        <Container>
          {userToken ? (
      ...
      <section  className="search-header new-header-section">
      ...
      {preCareData?.length > 0 ? preCareData?.map(function (object, i) {
        return (
          <div className="container">
        ...
        <p>No Pre & Post Treatment Care</p>
        </div> }
