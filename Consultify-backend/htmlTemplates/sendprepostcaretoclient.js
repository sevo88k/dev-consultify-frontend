const sendprepostcaretoclient = (name, salonname,) => {
  return `
                                        ...
                                        <tbody style="text-align: center;">
                                         ...
                                         <tr>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                                    <p class=""style="margin:0;padding-bottom: 10px;padding-top:20px;"> ${salonname} has sent you the following Pre / Post Care Form, “[Pre/Post Care Form Name]” for you to acknowledge and review. Click the button below to view the form:</p>
                                                </td>
                                            </tr>
...
module.exports = { sendprepostcaretoclient };