const sendingconsultationformtoclient = (name, salonname,days) => {
  return `  
                                        ...
                                        <tbody style="text-align: center;">
                                         ...
                                         <tr>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                                    <p class=""style="margin:0;padding-bottom: 10px;padding-top:20px;"> You have a “Pre / Post Care” Consultation Form to complete in preparation for your upcoming appointment at ${salonname}.</p>
                                                </td>
                                            </tr>
    ...
    <tr>
                                            ...
                                            <tr style="margin: 40px 0;">
                                                <td align="center" style=" padding:20px 0px;">
                                                    ...
                                                    <a style="font-family: 'Raleway', sans-serif;font-size:15px;  color: #ffffff;line-height:24px;font-weight: 600; border-radius: 30px; background: #0e4849;padding: 10px 25px;text-decoration: none;" href="https://salon.consultifyapp.com/verify_user/e089be09e6d3da827cd0e35041ceecb3546ea9b2f0ee88458fb6494f235629d1">Pre/Post Care Form </a>
                                                </td>
                                            </tr>
  <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                                    <p class=""style="margin:0;padding-bottom: 10px;padding-top:20px;"> Please acknowledge within the form that you have read the information carefully. This will ensure your treatment runs smoothly on the day.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                             ...
                                             <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                                    <p class=""style="margin:0;padding-bottom: 10px;padding-top:20px;"> The Consultify Teams</p>
                                                </td>
                                            </tr>
                                         <tr>
                                                <td align="center"  style="font-family: 'Raleway', sans-serif; font-size:37px; color:#000000; font-weight: bold;    padding: 12px 0;border-radius: 4px;">
...
module.exports = { sendingconsultationformtoclient };