...
const confirmAppointment = (data,emailcontent) => {
    return `<table width="100%" height="100%" border="0"  bgcolor="#f7f7f7" align="center" cellpadding="0" cellspacing="0" bgcolor="#fff">
<tbody>
            <tr>
          <td align="center">
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                                    <p class=""style="margin:0;padding-bottom: 10px;padding-top:20px;"> Hi ${data?.clientId?.first_name} ${data?.clientId?.last_name},</p>
                                                </td>
                                            </tr>
                                             ...
                                             <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                                    <p class=""style="margin:0;padding-bottom: 10px;padding-top:20px;"> ${data?.salonId?.salonname} has scheduled a video consultation at ${moment(data?.date).format("DD/MM/YYYY")} ${data?.time} with you.</p>
                                                </td>
                                            </tr>
   <tr>
                                                <td align="left" style="font-family: 'Raleway', sans-serif; font-size:17px; color:#000000; font-weight: 500;">
                                            ...
                                            <tr style="margin: 40px 0;">
                                                <td align="center" style=" padding:20px 0px;">
                                                    ...
                                                    <a style="font-family: 'Raleway', sans-serif;font-size:15px;  color: #ffffff;line-height:24px;font-weight: 600; border-radius: 30px; background: #0e4849;padding: 10px 25px;text-decoration: none;" href="https://customer.consultifyapp.com/Client_view">Video Consultation   </a>
                                                </td>
                                            </tr>
